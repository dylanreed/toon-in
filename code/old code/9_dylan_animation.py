...
class MouthAnimation:
    ...
    def __init__(self, window_size: Tuple[int, int] = (400, 400), 
        ...
        # Load all images
        self.body_image = self.load_image("/Users/nervous/Documents/GitHub/toon-in/assets/dylan/body.png")
    ...
    def load_viseme_images(self) -> Dict[str, pygame.Surface]:
        visemes = {}
        viseme_path = "/Users/nervous/Documents/GitHub/toon-in/assets/dylan/visemes"
    ...
    def load_blink_images(self) -> Dict[str, pygame.Surface]:
        blinks = {}
        blink_path = "/Users/nervous/Documents/GitHub/toon-in/assets/dylan/blink"
    ...
    def load_brow_images(self) -> Dict[str, pygame.Surface]:
        brows = {}
        brow_path = "/Users/nervous/Documents/GitHub/toon-in/assets/dylan/brows"
    ...
    def load_emotion_images(self) -> Dict[str, pygame.Surface]:
        emotions = {}
        emotion_path = "/Users/nervous/Documents/GitHub/toon-in/assets/dylan/emotions"
...
def main():
    ...
    background_path = "/Users/nervous/Documents/GitHub/toon-in/assets/background/dylan_background.png"
    ...
    animation = MouthAnimation(
        ...
        character_scale=0.4,  # Adjust this to change character size
    ...
    # animation.export_video("/Users/nervous/Documents/GitHub/toon-in/output/dylan/output.mp4", fps=60)
