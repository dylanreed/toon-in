...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate animation for Steve Norris')
    parser.add_argument('--audio_path', type=str, default="data/audio/steve/steve.wav",
    ...
    parser.add_argument('--output_path', type=str, default="output/norris/steve_episode_4_output.mp4",
